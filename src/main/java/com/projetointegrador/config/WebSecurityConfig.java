...
//                .antMatchers(HttpMethod.POST, "/api/v1/section/insert").hasAnyAuthority("ADMIN")
//                .antMatchers(HttpMethod.POST, "/api/v1/product/insert").hasAnyAuthority("ADMIN")
//                .antMatchers(HttpMethod.GET, "/api/v1/fresh-products/list/{{initials}}").hasAnyAuthority("ADMIN")
